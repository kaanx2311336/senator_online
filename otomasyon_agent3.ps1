...
$agentName = "AGENT3_UI"
$agentNum = 3
$logFile = "agent3_sessions_log.md"
$promptFile = "prompts/agent3_prompts.txt"
$sinyalDir = "sinyaller"

$dalgaAdimFaz = @{
    1 = @{ adim=1; fazlar=@("A3-1"); bekle=@() }
    2 = @{ adim=2; fazlar=@("A3-2"); bekle=@(2) }
    3 = @{ adim=2; fazlar=@("A3-3"); bekle=@(2) }
    4 = @{ adim=1; fazlar=@("A3-4"); bekle=@() }
    5 = @{ adim=1; fazlar=@("A3-5"); bekle=@() }
    6 = @{ adim=1; fazlar=@("A3-6"); bekle=@() }
}

# Dalga 1: A3-1 | Dalga 2: A3-2 | Dalga 3: A3-3
# Dalga 4: A3-4 | Dalga 5: A3-5 | Dalga 6: A3-6
$tumFazlar = @("A3-1","A3-2","A3-3","A3-4","A3-5","A3-6")
