...
$agentName = "AGENT1_SCENE"
$agentNum = 1
$logFile = "agent1_sessions_log.md"
$promptFile = "prompts/agent1_prompts.txt"
$sinyalDir = "sinyaller"

# Dalga -> Adim -> Fazlar haritasi
$dalgaAdimFaz = @{
    1 = @{ adim=1; fazlar=@("A1-1"); bekle=@() }
    2 = @{ adim=2; fazlar=@("A1-2"); bekle=@(2) }
    3 = @{ adim=2; fazlar=@("A1-3"); bekle=@(2) }
    4 = @{ adim=2; fazlar=@("A1-4"); bekle=@(2,3) }
    5 = @{ adim=2; fazlar=@("A1-5"); bekle=@(2,3) }
    6 = @{ adim=1; fazlar=@("A1-6"); bekle=@() }
}

# Dalga 1: A1-1 | Dalga 2: A1-2 | Dalga 3: A1-3
# Dalga 4: A1-4 | Dalga 5: A1-5 | Dalga 6: A1-6
$tumFazlar = @("A1-1","A1-2","A1-3","A1-4","A1-5","A1-6")
