...
$agentName = "AGENT4_INTERACT"
$agentNum = 4
$logFile = "agent4_sessions_log.md"
$promptFile = "prompts/agent4_prompts.txt"
$sinyalDir = "sinyaller"
...
# Dalga 1: A4-1 | Dalga 2: A4-2 | Dalga 3: A4-3
# Dalga 4: A4-4 | Dalga 5: A4-5 | Dalga 6: A4-6
$tumFazlar = @("A4-1","A4-2","A4-3","A4-4","A4-5","A4-6")
